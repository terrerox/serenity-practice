...
namespace practice1.Migrations.DefaultDB
{
    ...
    public class DefaultDB_20141103_140000_Initial : AutoReversingMigration
    {
        public override void Up()
        {
            ...
            this.CreateTableWithId32("Orders", "Id", s => s
                .WithColumn("UserId").AsInt32().NotNullable()
                    .ForeignKey("FK_Orders_UserId", "dbo", "Users", "UserId")
                .WithColumn("Amount").AsInt32().Nullable()
                .WithColumn("Tax").AsInt32().Nullable()
                .WithColumn("Address").AsString(1000).Nullable()
                .WithColumn("Status").AsInt32().Nullable().WithDefaultValue(1));

            this.CreateTableWithId32("OrderDetails", "Id", s => s
                .WithColumn("OrderId").AsInt32().NotNullable()
                    .ForeignKey("FK_OrderDetails_OrderId", "dbo", "Orders", "Id")
                .WithColumn("ProductId").AsInt32().NotNullable()
                    .ForeignKey("FK_OrderDetails_ProductId", "dbo", "Products", "Id")
                .WithColumn("Total").AsInt32().Nullable()
                .WithColumn("Quantity").AsInt32().Nullable()
                .WithColumn("ItemAmount").AsInt32().Nullable()
                .WithColumn("ItemTax").AsInt32().Nullable());

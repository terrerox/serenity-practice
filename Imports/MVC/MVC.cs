...
namespace MVC
{
    public static class Views
    {
        ...
        public static class Customer
        {
            ...
            {
                public const string OrdersIndex = "~/Modules/Customer/Orders/OrdersIndex.cshtml";
            }
        }
        ...
        public static class Local
        {
            public static class Orders
            {
                public const string OrdersIndex = "~/Modules/Local/Orders/OrdersIndex.cshtml";
            }

            public static class Products
            {
                public const string ProductsIndex = "~/Modules/Local/Products/ProductsIndex.cshtml";
            }
